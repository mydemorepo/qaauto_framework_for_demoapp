...
# Перевірка правильності списку таблиць які надсилає сервер.
@pytest.mark.jsonapi   
...
# Перевірка правильності вмісту таблиць які надсилає сервер.        
@pytest.mark.jsonapi    
...
# Перевірка правильності вмісту таблиць які надсилає сервер коли вибрані певні колонки таблиці. 
@pytest.mark.jsonapi                    
